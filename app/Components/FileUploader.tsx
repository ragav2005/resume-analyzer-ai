...

                    {
                        file ?
                            <div className="uploader-selected-file" onClick={(e) => e.stopPropagation()}>
                                ...
                                <button className="p-2 cursor-pointer ml-auto" onClick = { (e) =>
                                {onFileSelect?.(null)}
                                } >
                                    <img src="public/icons/cross.svg" alt="remove" className="h-4 w-4" />
                                </button>
                            </div>
                            : <div>
                                <div className='flex items-center justify-between w-16 mx-auto mb-2'>
